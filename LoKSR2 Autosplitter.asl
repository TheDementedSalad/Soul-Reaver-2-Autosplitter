...
split
{
	if(settings["Gless"]){
		...
		if(current.Cutscene == 4 && current.Reavers == 28 && current.X >= -480f && current.X <= -460f && current.Y >= 10396f && current.Y <= 10402f && current.Z >= -2075f && current.Z <= -2060f && vars.split2 == 0){
			if(settings["18"]){
				vars.split2++;
				return true;
			}
